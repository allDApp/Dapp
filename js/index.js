...
var dappAddress = "n1r76yKycDFLQTgweLPShSpP8ziRwwqXpv9";
$(function() {
	...
	$("#mydapps").click(function() {
		$("#detailTitle").text("My DApps-收藏DApp");
	...
	$("#newdapp").click(function() {
		...
		tempStr += '<p>提交保证金-会显示在展示页面呦,提交的多,审核速度就快,用户更可能会访问你的应用</p>';
...
function save(){
	...
	var nebpay = new NebPay();
		...
		var callArgs = "[\"" + "地址:http://alldapp.github.io/" + ids + "/\u003cbr\u003e描述:" + content + '","' + name + "\"]";
		nebpay.call(to, value, callFunction, callArgs, {
